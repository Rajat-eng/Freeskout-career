...
const LoginModel = () => {
  ...
  const [loginApplicant,{isLoading,isSuccess}]=useLoginApplicantMutation()
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          {isAuthenticated===false && <div className={`${style.loginModelContainer}`}>
            <div className={`${style.loginWrapper}`}>
              <div className={`${style.loginTitle}`}>
                ...
                >
                  <input type="text" className="form-check-input" id="admin" />
                  &nbsp;
                  <NavLink to="/hr-login">
